  ...
  return (
    <>
      ...
      >
        ...
        >
          <div style={{ width: '100%', borderBottom: '1px solid #666666', paddingBottom: '2rem' }}>
            <span style={{
          ...
          {chats.map((option) => (
            <div style={{
              display: 'flex', flexDirection: 'row', padding: '1rem ', borderBottom: '1px solid #666666',
            }}
            >
              <div>
